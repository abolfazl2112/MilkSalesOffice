...
namespace system
{
    public partial class vshir_list : Office2007Form
    {
        string sql;
        connect con;
        public vshir_list()
        ...
        {
            // TODO: This line of code loads data into the 'dataSet.vshir' table. You can move, or remove it, as needed.
            this.vshirTableAdapter.Fill(this.dataSet.vshir);
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            sql = "DELETE FROM vshir WHERE (codemar = N'" + dataGridViewX1.CurrentRow.Cells[0].Value.ToString() + "')AND (date = N'" + dataGridViewX1.CurrentRow.Cells[2].Value.ToString() + "') AND (nobat = N'" + dataGridViewX1.CurrentRow.Cells[3].Value.ToString() + "')";
            con.connection();
            if (con.exe_data(sql))
            {
                dataGridViewX1.DataSource = con.show_data("select * from vshir");
        ...
        private void btnRight_Click(object sender, EventArgs e)
        {
            ...
            printer.Title = "لیست ورود روزانه شیر";
