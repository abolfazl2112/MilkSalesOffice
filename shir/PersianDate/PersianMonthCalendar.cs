...
//    using PersianDate.Properties;
    ...
    public partial class PersianMonthCalendar : Control
    {
        ...
        {
            //((PictureBox)sender).Image = Resources.rightDown;
        }

        private void prevMonthButton_MouseDown(object sender, MouseEventArgs e)
        {
           // ((PictureBox)sender).Image = Resources.leftdown;
        }
        ...
        {
            //((PictureBox)sender).Image = Resources.right;
        }

        private void prevMonthButton_MouseUp(object sender, MouseEventArgs e)
        {
            //((PictureBox)sender).Image = Resources.left;
        }
