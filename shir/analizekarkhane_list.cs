...
namespace system
{
    public partial class analizekarkhane_list : Office2007Form
    {
        string sql;
        connect con;
        public analizekarkhane_list()
        {
            InitializeComponent();
            con = new connect();
        }

        private void analizekarkhane_list_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dataSet.analizekarkhane' table. You can move, or remove it, as needed.
            this.analizekarkhaneTableAdapter.Fill(this.dataSet.analizekarkhane);
        ...
        {
            analizekarkhane ak = new analizekarkhane();
            ak.type = 1;
            ak.ShowDialog(this);

            con.connection();
            dataGridViewX1.DataSource = con.show_data("select * from analizekarkhane");
            con.Disconnect();
        }
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            analizekarkhane ak = new analizekarkhane();
            ak.type = 2;
            ak.settxt(dataGridViewX1.CurrentRow);
            ak.ShowDialog(this);
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            sql = "DELETE FROM analizekarkhane WHERE (codemahmole = N'" + dataGridViewX1.CurrentRow.Cells[0].Value.ToString() + "')";
            con.connection();
            if (con.exe_data(sql))
            {
                dataGridViewX1.DataSource = con.show_data("select * from analizekarkhane");
        ...
        private void btnRight_Click(object sender, EventArgs e)
        {
            ...
            printer.Title = "لیست آنالیز شیر کارخانه ها";
